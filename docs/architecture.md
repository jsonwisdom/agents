...
- **98 marketplace plugins** (94 local + 4 external via git-subdir) optimized for specific use cases
...
claude-agents/
├── .claude-plugin/
│   └── marketplace.json          # Marketplace catalog (98 plugins)
...
- **100% component availability** - all 205 local agents accessible across plugins
