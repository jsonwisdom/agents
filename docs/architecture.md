...
- **101 marketplace plugins** (97 local + 4 external via git-subdir) optimized for specific use cases
- **26 clear categories** with 1-12 plugins each for easy discovery
- Organized by domain:
...
- Domain-specific expertise across 50 plugins
...
- **100% component availability** - all 208 local agents accessible across plugins
