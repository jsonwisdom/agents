...
| **computer-wisdom-assistant**  | Judgment assistant with Agent Skills for evidence-first review, bounded authority, replayable reasoning, complexity budgets, and pattern fidelity | `/plugin install computer-wisdom-assistant` |
