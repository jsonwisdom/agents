...
> Production-ready agentic workflow building blocks: **101 plugins**, **208 agents**,
> **171 skills**, **118 commands** — built for Claude Code and consumed natively by
...
| | Count | What it is |
|---|---:|---|
| **Plugins** | 101 | Granular, single-purpose installable units (97 local + 4 external via git-subdir) |
| **Agents** | 208 | Domain experts (architecture, languages, infra, security, data, ML, docs, business, SEO) |
| **Skills** | 171 | Modular knowledge packages with progressive disclosure (load when activated) |
| **Commands** | 118 | Slash commands: scaffolding, security scans, test gen, infrastructure setup |
...
- **[docs/agents.md](docs/agents.md)** — all 208 agents by category
