...
> Production-ready agentic workflow building blocks: **99 plugins**, **206 agents**,
> **168 skills**, **115 commands** — built for Claude Code and consumed natively by
...
/plugin install python-development          # or any of 99 plugins
```
...
| | Count | What it is |
|---|---:|---|
| **Plugins** | 99 | Granular, single-purpose installable units (95 local + 4 external via git-subdir) |
| **Agents** | 206 | Domain experts (architecture, languages, infra, security, data, ML, docs, business, SEO) |
| **Skills** | 168 | Modular knowledge packages with progressive disclosure (load when activated) |
| **Commands** | 115 | Slash commands: scaffolding, security scans, test gen, infrastructure setup |
...
- **[docs/plugins.md](docs/plugins.md)** — full catalog of all 99 plugins
- **[docs/agents.md](docs/agents.md)** — all 206 agents by category
- **[docs/agent-skills.md](docs/agent-skills.md)** — 168 skills with progressive disclosure
