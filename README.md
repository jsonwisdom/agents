...
> Production-ready agentic workflow building blocks: **98 plugins**, **205 agents**,
...
/plugin install python-development          # or any of 98 plugins
```
...
| | Count | What it is |
|---|---:|---|
| **Plugins** | 98 | Granular, single-purpose installable units (94 local + 4 external via git-subdir) |
| **Agents** | 205 | Domain experts (architecture, languages, infra, security, data, ML, docs, business, SEO) |
...
- **[docs/plugins.md](docs/plugins.md)** — full catalog of all 98 plugins
- **[docs/agents.md](docs/agents.md)** — all 205 agents by category
