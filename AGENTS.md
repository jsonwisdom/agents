...
Production-ready agentic-workflow building blocks: **101 plugins** (97 local + 4 external), **208 agents**, **171 skills**, **118 commands**. Native source-of-truth for Claude Code; also consumed by OpenAI Codex CLI, Cursor, OpenCode, Gemini CLI, and Qwen Code from a single Markdown source.
...
- **[docs/plugins.md](docs/plugins.md)** — full plugin catalog (101 plugins by category)
- **[docs/agents.md](docs/agents.md)** — agent reference (208 agents, model tiers)
...
208 subagents under `plugins/*/agents/<name>.md`. Per-harness transpilation:
