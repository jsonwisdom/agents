...
Production-ready agentic-workflow building blocks: **98 plugins** (94 local + 4 external), **205 agents**, **166 skills**, **113 commands**. Native source-of-truth for Claude Code; also consumed by OpenAI Codex CLI, Cursor, OpenCode, and Gemini CLI from a single Markdown source.
...
- **[docs/plugins.md](docs/plugins.md)** — full plugin catalog (98 plugins by category)
- **[docs/agents.md](docs/agents.md)** — agent reference (205 agents, model tiers)
...
205 subagents under `plugins/*/agents/<name>.md`. Per-harness transpilation:
